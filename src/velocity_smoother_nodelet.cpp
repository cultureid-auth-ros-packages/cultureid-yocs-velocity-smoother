...
#include <cultureid_yocs_velocity_smoother/paramsConfig.h>

#include <ecl/threads/thread.hpp>

#include "cultureid_yocs_velocity_smoother/velocity_smoother_nodelet.hpp"
...
namespace cultureid_yocs_velocity_smoother {
...
PLUGINLIB_EXPORT_CLASS(cultureid_yocs_velocity_smoother::VelocitySmootherNodelet, nodelet::Nodelet);
